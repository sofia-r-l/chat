...
try {
    ...
    if (empty($idLibro) || empty($titulo) || empty($autor) || empty($etiquetas)) {
    ...
    $datosLibros['libros'][$indiceLibro]['etiquetas'] = $etiquetas;
    ...
    echo json_encode([
        ...
        'libro' => [
            ...
            'etiquetas' => $datosLibros['libros'][$indiceLibro]['etiquetas'],
