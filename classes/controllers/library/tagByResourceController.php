...
class TagByResourceController
{
    ...
    {
        $this->service = new TagByResourceService();
    }
    ...
    public function handleRequest()
    {
        ...
        try {
            switch ($_SERVER['REQUEST_METHOD']) {
                case 'GET':
                    $this->getTagsToResource((int) $_GET['id_resource']);
                    break;
                case 'POST':
                    //  $this->uploadResource();
                    break;
    ...
    public function getTagsToResource($idResource)
    {
        try {
            ...
            $resultado = $this->service->getTagByResource($idResource);
            ...
            error_log("Error en TagByResourcesController: " . $e->getMessage());
